...
public class MyRedisTokenStore implements TokenStore {
    ...
    public void storeAccessToken(OAuth2AccessToken token, OAuth2Authentication authentication) {
        ...
        try {
            ...
            if (refreshToken != null && refreshToken.getValue() != null) {
                ...
                conn = check(refreshToken, refreshToAccessKey, accessToRefreshKey, conn);
            }
            conn.closePipeline();
        } finally {
            conn.close();
    ...
    public void storeRefreshToken(OAuth2RefreshToken refreshToken, OAuth2Authentication authentication) {
        ...
        try {
            ...
            conn = check(refreshToken, refreshKey, refreshAuthKey, conn);
            conn.closePipeline();
        } finally {
            conn.close();
        }
    ...
    private RedisConnection check(OAuth2RefreshToken refreshToken, byte[] refreshKey, byte[] refreshAuthKey, RedisConnection conn) {
